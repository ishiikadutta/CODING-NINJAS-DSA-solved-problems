...
Tower of Hanoi is a mathematical puzzle where we have three rods and n disks. The objective of the puzzle is to
 move all disks from source rod to destination rod using third rod (say auxiliary). The rules are :
...
/* See D:\HITK\CODING NINJAS- C++ AND DSA\DSA in C++\Tower of Hanoi for more details to this question */
...
{
    int n;
    char source,auxillary,destination;
    source='a';
    auxillary='b';
    destination='c';
    cin>>n;
